require("trouble").setup({
	...
	group = true, -- group diagnostics by source
	padding = true, -- add padding to the left of the list
	action_keys = {
		...
		hover = "Z", -- opens a small poup with the full multiline message
		preview = "p", -- preview the diagnostic location
		close_folds = { "zM", "zm" }, -- close all folds
		open_fold = { "<space>" }, -- open / close a fold
		toggle_fold = { "z", "x" }, -- toggle fold of current file
